...
//	Inserting an element to a self balancing BST takes Logn time (See this) where n is size 
//	of the BST. So time complexity of this method is Log(n) + Log(n+1) … Log(m+n-1). 
